// ─── SignupForm ───────────────────────────────────────────────────────────────
// Presentational signup form. All business logic is in useSignupForm.
//
// Notable additions over the original:
//  • PasswordInput with show/hide toggle.
//  • PasswordStrengthMeter with live requirements checklist.
//  • react-hook-form integration (controlled via register/Controller).
//  • Proper aria-* attributes on all inputs.
//  • FieldError components for accessible inline errors.
//  • FormAlert for form-level errors with role="alert".
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <PasswordInput
              ...
              // We use a custom onChange to update the strength meter in parallel
              {...register("password", {
